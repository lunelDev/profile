...
export const projects: Project[] = [
  ...
  },
  {
    ...
    period: "2020–2023",
    category: "game",
    role: "사이클링투어를 부산 테마로 재구성 — 부산 맵 배치·DollyTrack 카메라 경로·레벨 디자인, 다국어",
    collab: "센서 raw 연결·변환은 협업",
    tags: ["Unity", "C#", "FIT-TAG BLE", "Cinemachine", "Localization"],
    summary:
      "고정형 자전거에 장착한 BLE 센서로 가상의 부산 도시를 주행하는 실감형 피트니스 게임. 기존 아시아 코스 버전을 부산 버전으로 재구성했다.",
    highlights: [
      "부산 랜드마크 5종(누리마루·해운대·광안대교·BEXCO·영화의전당) 코스로 맵 배치·레벨 디자인",
      "Cinemachine DollyTrack 주행 카메라 경로",
      "Unity Localization 한/영 다국어",
    ],
  ...
  },
  {
    ...
    tags: ["Unity", "C#", "Leia 3D", "URP", "DOTween"],
